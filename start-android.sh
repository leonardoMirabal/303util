...
if [ ! -x "${EMULATOR_BIN}" ]; then
  ...
  echo "  sdkmanager \"platform-tools\" \"emulator\" \"platforms;android-${ANDROID_COMPILE_SDK_VERSION}\" \"system-images;android-${ANDROID_COMPILE_SDK_VERSION};google_apis;x86_64\""
  exit 1
fi
...
write_android_sdk_properties() {
  local properties_file="${SCRIPT_DIR}/src-tauri/gen/android/app/tauri.properties"
