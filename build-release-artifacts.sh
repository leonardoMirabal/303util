...
ANDROID_COMPILE_SDK_VERSION="${ANDROID_COMPILE_SDK_VERSION:-36}"
ANDROID_TARGET_SDK_VERSION="${ANDROID_TARGET_SDK_VERSION:-${ANDROID_COMPILE_SDK_VERSION}}"
...
android.compileSdkVersion=${ANDROID_COMPILE_SDK_VERSION}
